        ...
        private void detectCouplingMethod()
        {
            try
            {
                ...
                while (nodeIterator.MoveNext())
                {
                    ...
                    while (iterFilename.MoveNext()) sbResults.AppendLine("Filename : " + iterFilename.Current.Value);
                    ...
                    while (iterFieldName.MoveNext())
                    {
                        ...
                        sbResults.AppendLine("Field Name : " + sFieldName);
                        // Get Methods using those variables
                        sUnitXML = new StringReader(sUnitOuterXML);
                        ...
                        while (iterMethodName.MoveNext())
                        {
                            ...
                            sbResults.AppendLine(String.Format("The field {0} is being used in the method named {1}.", sFieldName, sMethodName));
                        }
                    }
